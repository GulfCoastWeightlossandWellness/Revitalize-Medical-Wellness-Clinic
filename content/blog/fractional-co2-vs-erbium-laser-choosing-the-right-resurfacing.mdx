...
metaDescription: >-
  Fractional CO2 vs erbium laser explained by Travis Woodley, MSN, RN, CRNP —
...
In laser resurfacing comparison, the specific anatomical considerations include:
...
We assess all of these at the consultation, not at the treatment. A consultation that does not include a face-in-motion assessment is not a real assessment. Fractional CO2 vs erbium laser cannot be planned from a static photo.

## How the procedure actually works

For most aesthetic treatments, including Fractional CO2 vs Erbium Laser, the actual procedure is brief — typically 15 to 30 minutes once the consultation has been completed. The areas to be treated are mapped, marked, and treated systematically. Most patients are surprised by how unremarkable the procedure itself is.
...
If you are considering fractional CO2 vs erbium laser for yourself, the first step is a consultation. Book at either [Columbus](/locations/columbus-ga) or [Warner Robins](/locations/warner-robins-ga). We will assess what is appropriate for your anatomy and your goals, and we will be honest about what the realistic outcomes look like.

## Common patterns we see in patients asking about Fractional CO2 vs Erbium Laser

The patients we see asking about fractional CO2 vs erbium laser fall into a few recognizable patterns. Recognizing the pattern early often shortens the path to a useful answer.
