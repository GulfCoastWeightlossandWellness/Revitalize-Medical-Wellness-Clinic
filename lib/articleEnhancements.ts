...
export const ARTICLE_ENHANCEMENTS: Record<string, ArticleEnhancement> = {
  ...
  "how-to-choose-medical-spa-columbus-ga": {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes. Patients travel from Phenix City, Fort Benning, Warner Robins, Macon, Auburn, and surrounding areas. The Columbus and Warner Robins locations serve the broader Central Georgia and East Alabama region.",
      },
    ],
  },
  ...
  "medical-weight-loss-columbus-ga": {
    ...
    cta: {
      ...
      body: "Revitalize Columbus serves patients from Columbus, Phenix City, Fort Moore, Auburn, and surrounding communities. Book your metabolic evaluation online.",
    ...
    faq: [
      {
        ...
        a: "Revitalize Columbus is located at 7020 Moon Rd, Suite 204, Columbus, GA 31909. The clinic serves patients from Columbus, Phenix City, Fort Moore (formerly Fort Benning), Auburn, Opelika, and the broader Chattahoochee Valley region.",
      },
      {
        q: "How do I book a medical weight loss consultation in Columbus, GA?",
        a: "Online booking is available 24/7 at revitalizeaesthetics.janeapp.com. You can also call the Columbus clinic directly at (706) 507-5100.",
      },
      {
