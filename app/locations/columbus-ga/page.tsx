          ...
          <FadeIn>
            <div>
              ...
              <p style={{ fontSize: "0.88rem", lineHeight: 1.85, color: "rgba(255,255,255,0.45)", marginBottom: "20px" }}>
                The Columbus clinic welcomes patients from Columbus, Phenix City (AL), Fort Benning and the surrounding military community,
