...
const STATIC_ROUTES: {
  ...
  { path: "/institute",                                       priority: 0.9, changeFrequency: "monthly" },
  { path: "/institute/core",                                  priority: 0.85, changeFrequency: "monthly" },
  { path: "/institute/elite",                                 priority: 0.85, changeFrequency: "monthly" },
  { path: "/institute/metabolic-year",                        priority: 0.85, changeFrequency: "monthly" },
  { path: "/institute/hormone-optimization-coaching",         priority: 0.78, changeFrequency: "monthly" },
  { path: "/institute/metabolic-health-program",              priority: 0.78, changeFrequency: "monthly" },
  { path: "/institute/weight-loss-coaching",                  priority: 0.78, changeFrequency: "monthly" },
  { path: "/institute/mens-health-coaching",                  priority: 0.78, changeFrequency: "monthly" },
  { path: "/institute/womens-hormone-coaching",               priority: 0.78, changeFrequency: "monthly" },
